...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.square().and(joystick.circle()).whileTrue(drivetrain.sysIdDynamic(Direction.kForward));
        joystick.square().and(joystick.cross()).whileTrue(drivetrain.sysIdDynamic(Direction.kReverse));
        joystick.triangle().and(joystick.circle()).whileTrue(drivetrain.sysIdQuasistatic(Direction.kForward));
        joystick.triangle().and(joystick.cross()).whileTrue(drivetrain.sysIdQuasistatic(Direction.kReverse));
